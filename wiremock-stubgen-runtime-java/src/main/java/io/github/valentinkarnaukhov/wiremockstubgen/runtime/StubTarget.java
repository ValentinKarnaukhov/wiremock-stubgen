 ...
 *
 * <p>Exists because WireMock is not always in-process: it is frequently a shared
 * deployment that tests talk to over the admin API. Generated code registers stubs
 * through this interface and therefore does not care which of the two it is.
 */
@FunctionalInterface
